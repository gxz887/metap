...
<body class="strong-login">
	...
	<div id="mq_login_title">运营管理系统</div>
							...
							<div class="padder">
								...
								<div class="sign-input">
									<span class="input"><input autocomplete="on"
										name="loginName" id="u" type="text" style="ime-mode: disabled"
										class="input01" tabindex="1" value="帐号"
										onfocus="if (value =='帐号'){value =''}"
										onblur="if (value ==''){value='帐号';}" /></span>
								</div>
								<div class="sign-input">
	...
	<div class="footer">Copyright @2010-2013 metaP. All Rights
		Reserved.</div>
	<!--4-->
</body>
</html>
